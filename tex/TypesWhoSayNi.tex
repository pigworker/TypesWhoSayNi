...
The formal grammar of patterns is as follows:
...
\begin{definition}[$\omega$-$\gamma$-expression]
  The $\omega$-$\gamma$-expressions are liberal constructions in the full syntax of
  terms, augmented by the liberal constructions $\xi/\sigma$, where
  $\xi : \emp,\delta \thin \omega$ and $\sigma : \delta\su\gamma$.
  Expressions in the synthesis rule for an elimination may also contain the
  essential computation, $\trg$, standing for the target.
\end{definition}
...
initial $\emp,$ of a substitution, and we may omit the $/$ when the substitution is
...
Let me emphasize a key consequence of Dogma \ref{dogma:clockwise}: subjects of premises
come only from the subject of a conclusion; a rule establishes trust in \emph{every} part of its
conclusion's subject; trust, once established, is \emph{never} revisited.
...
I propose to achieve that basic and useful property
