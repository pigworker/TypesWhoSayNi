...
\begin{definition}[schematic scope]
  A schematic scope is a pair $(\delta,p)$, where $\delta$ is an
...
\begin{definition}[expression]
  The syntax of expressions $\Ex{(\delta,p)}ld\gamma$, with
  schematic scope $(\delta,p)$ and scope $\gamma$ extends that
  of terms, as follows:
\[\begin{array}{r|l|l}
 d \;\backslash\; l& \ess\mbox{ential} & \lib\mbox{eral} \\
\hline
