...
\begin{definition}[configurable type construction\label{def:tycon}]
...
\begin{definition}[configurable elimination rule\label{def:elimrule}]
...
\begin{definition}[configurable universe checking\label{def:univ}]
