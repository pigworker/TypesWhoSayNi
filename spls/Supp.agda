...
thickEnv (!!! a) (! .a) th (!!! .a) refl = !!! a , refl , refl
thickEnv (!!! a) (_ & _) th (!!! .a) ()
thickEnv (!!! a) (\\ t) th (!!! .a) ()
thickEnv (!!! a) (thnk t) th (!!! .a) ()
thickEnv (!!! a) (x ?- _) th (!!! .a) ()
thickEnv (p &&& q) (s & t) th (ss' &&& ts') z = termNoConf z \ z -> termNoConf z \ z0 z1 ->
  let ss , sq , sq' = thickEnv p s th ss' z0 in
  let ts , tq , tq' = thickEnv q t th ts' z1 in
  ss &&& ts , _&&&_ $= sq =$= tq , _&_ $= sq' =$= tq'
thickEnv (p &&& q) (! a) th (ss' &&& ts') ()
thickEnv (p &&& q) (\\ t) th (ss' &&& ts') ()
thickEnv (p &&& q) (thnk t) th (ss' &&& ts') ()
thickEnv (p &&& q) (x ?- _) th (ss' &&& ts') ()
thickEnv (\\\ q) (! a) th (\\\ ts') ()
thickEnv (\\\ q) (_ & _) th (\\\ ts') ()
thickEnv (\\\ q) (\\ t) th (\\\ ts') z = termNoConf z \ z -> termNoConf z \ z ->
  let ts , tq , tq' = thickEnv q t th ts' z in
  \\\ ts , \\\_ $= tq , \\_ $= tq'
thickEnv (\\\ q) (thnk t) th (\\\ ts') ()
thickEnv (\\\ q) (x ?- _) th (\\\ ts') ()
thickEnv {ga = ga} {ga'} {de'} (??? _ {de} ph) t th (??? s) z
  with pullback  (th ^+ oi {S = de'})(oi {S = ga'} ^+ ph)
    | pullbackFact th ph
    | pullbackTerm t (th ^+ oi {S = de'}) s (oi {S = ga'} ^+ ph) (sym z)
... | ._ | refl | u , refl , refl = ??? u , refl , refl
